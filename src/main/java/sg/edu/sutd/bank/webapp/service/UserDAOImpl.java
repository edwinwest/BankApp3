...
public class UserDAOImpl extends AbstractDAOImpl implements UserDAO {
	...
	public User loadUser(String userName) throws ServiceException {
		...
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT id, user_name, status FROM USER WHERE user_name=? and attempt <5");
	...
	@Override
	public void updateAttemptFailed(String userName) throws ServiceException{
		Connection conn = connectDB();
		PreparedStatement ps = null;
		ResultSet rs = null;
		int attempt = 0;
		...
		rs = null;
		try {
			ps = prepareStmt(conn, "UPDATE user SET attempt = ? WHERE user_name = ?");
			int idx = 1;
			ps.setInt(idx++, attempt);
	...
	@Override
	public void updateAttemptSuccess(String userName) throws ServiceException{
		Connection conn = connectDB();
		PreparedStatement ps = null;
		ResultSet rs = null;
		int attempt = 0;
	...
	@Override
	public boolean checklockout(String userName) throws ServiceException {
		Connection conn = connectDB();
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	@Override
	public boolean checkApproved(String userName) throws ServiceException {
		Connection conn = connectDB();
		PreparedStatement ps = null;
		ResultSet rs = null;
		boolean Approved = true;
		try {
			ps = conn.prepareStatement("SELECT id, user_name, status FROM USER WHERE user_name=? and status is null");
			ps.setString(1, userName);
			rs = ps.executeQuery();
			if (rs.next()) {
				Approved = false;
