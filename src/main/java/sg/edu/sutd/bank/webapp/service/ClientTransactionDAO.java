...
public interface ClientTransactionDAO {
	...
	void createNeedApproval(ClientTransaction clientTransaction) throws ServiceException;
	
	void createAutoApproval(ClientTransaction clientTransaction) throws ServiceException;
	
	void Transfer(int transferId) throws ServiceException;
