...
public class ClientDashboardServlet extends DefaultServlet implements Serializable{
	private static final long serialVersionUID = 1L;
	private transient ClientInfoDAO clientInforDao = new ClientInfoDAOImpl();
