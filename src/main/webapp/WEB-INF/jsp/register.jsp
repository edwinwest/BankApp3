		...
		<div class="containter registrationForm">
			<form id="registrationForm" action="register" method="post">
				...
				<div id="input-group-password" class="form-group">
					...
					<label for="password" style="font-size:10px;" class="col100 red">Password needs to be at least 8 characters and contain at least 1 letter, 1 digit and 1 symbol.</label>
				</div>
